...
st.markdown("<h1 style = 'color: #072541; text-align: center;font-family: Arial, Helvetica, sans-serif; '>SAMSUNG PHONE SALES CHATBOT</h1>", unsafe_allow_html= True)
st.markdown("<h3 style = 'margin: -25px; color: #072541; text-align: center;font-family: Arial, Helvetica, sans-serif; '> CHATBOT BUILT BY Olukunle Godfirst</h3>", unsafe_allow_html= True)


st.markdown("<br> <br>", unsafe_allow_html= True)
col1, col2 = st.columns(2)
col1.image('pngwing.com (9).png', caption = 'Samsung Customer chatbot')
